...
<div class="header">
  <h1 style="text-align: center;font-size:50px;">Array Extraction</h1>
</div>
...
outline: none;
    ...
    <?php } ?>
          ...
          function update(){
            document.getElementById("div1").innerHTML=("<div class='boxedItem' style='font-size:35px'>"+scripts.join("</div><br><div class='boxedItem'style='font-size:35px'>")+"</div>");
            var x = Array(...document.getElementsByClassName("boxedItem"))
            x.forEach((e)=>e.className+=" boxAnime")
          }
          function update1(){
            document.getElementById("div2").innerHTML=("<div class='boxedItem'style='font-size:35px'>"+scripts.join("</div><br><div class='boxedItem'style='font-size:35px'>")+"</div>");
            var x = Array(...document.getElementsByClassName("boxedItem"))
            x.forEach((e)=>e.className+=" boxAnime")
          }
          ...
          function update3(){
            document.getElementById("div3").innerHTML=("<div class='boxedItem'style='font-size:35px'>"+scripts.join("</div><br><div class='boxedItem'style='font-size:35px'>")+"</div>");
            var x = Array(...document.getElementsByClassName("boxedItem"))
            x.forEach((e)=>e.className+=" boxAnime")
          }
          
          function update4(){
            document.getElementById("div4").innerHTML=("<div class='boxedItem'style='font-size:35px'>"+scripts.join("</div><br><div class='boxedItem'style='font-size:35px'>")+"</div>");
            var x = Array(...document.getElementsByClassName("boxedItem"))
            x.forEach((e)=>e.className+=" boxAnime")
          }
...
<h6><font color="green">if input not entered Then by default index  number <b>*0-th element </b>will be deleted</font></p>
