...
<div class="card">
      <h2>Zero based indexing</h2>
         ...
         <p>Zero-based array indexing is a way of numbering the items in an array such that the first item of it has an index of 0,In modern-day computer science, most programming languages such as Python, Ruby, PHP, Java have array indices starting at zero. A big reason for this is that it provides a clear distinction that ordinal forms
<p>
    </div><hr>
