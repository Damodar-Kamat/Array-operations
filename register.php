...
<body>
  ...
  </script>      <form  action="#" method="post" width="200px" enctype="multipart/form-data"  >
        <h2>Sign-up Form</h2><h5 ><font color="red"> Note:<br><hr>

       1)&nbsp *Username Must Be Alphabets and Length should be more than 5 and less than 15 letters<br>

      2)&nbsp *Password Length should be >=8<br>
    </font></h5>
  <center>
  ...
  <div class="container signin">
    <p>Already have an account? <a href="loginmodal.php">Login-Now</a>.</p>
  </div>
</form>
                  </center>
