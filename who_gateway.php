...
<div class="topnav">
  ...
  <a href="insertion.php" active id="active">Insertion</a>
...
<h2> Note:</h2><hr>
<br><b>A is Address </b><br><hr>
<b>i is index </b><hr><br>
...
if($total !== 0 )
{
        ...
        <td><input type=text hidden  value=".$result['size']." 
          ...
          <td>  <div class=div_shadow><font color=black>A-</font>".$result['address']."
          <td>  <div class=div_shadow><font color=black>i-</font>".$result['IndexNumber']."
        ...
        $sql ="INSERT into who VALUES ('','$username','$phonenumber','$size','$IndexNumber','$address','$value','$datetime')";
    ...
    </tr><?php             header( "refresh:2, url=who.php");

         
        if($data2){
            echo"<p>&hearts;<p>";
            header( "refresh:2; url=deletion_page.php");
        }else{
            echo"errorr";
        }
