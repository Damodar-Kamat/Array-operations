...
if($total !== 0 )
{
  ...
  ?><table border="dotted">
   ...
   <tr><td><input type=text placeholder=l   readonly value=".$result['SL_NO']." ></td>

    <td><input type=text placeholder=l   readonly value=".$result['username']." ></td>

    <td><input type=text placeholder=l   readonly value=".$result['size']." ></td>

    <td><input type=text placeholder=l   readonly value=".$result['IndexNumber']." ></td>

    <td><input type=text placeholder=l   readonly value=".$result['address']." ></td>

    <td><input type=text placeholder=l   readonly value=".$result['value']." ></td>

    <td><input type=textarea placeholder=l   readonly value=".$result['last_insert_time']." ></td>
